 ...
 * plain pub/sub channels (`prs:<channel>`). This is the same helper the repo's
 * e2e app uses; presence is layered entirely on top of the transport's
 * subscribe/publish so the SSE server needs no presence-specific code.
 *
 ...
 */
import type { PresenceUser, RealtimeTransport } from '@realtimejs/core'
