...
/**
 * Subscribes to a paginated reactive server query and auto-updates page 1
 * when the server publishes new data on its channel.
 *
 ...
 *   usePaginatedQuery(getTodos, { teamId }, { pageSize: 20 })
 */
