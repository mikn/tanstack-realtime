 ...
 *
 * Vue provider and composables for @tanstack/realtime.
 */

// Re-export everything from the framework-agnostic core so consumers only
// need a single import: `import { createRealtimeClient, useRealtime } from '@tanstack/vue-realtime'`
...
// Convenience composables for common real-time UI patterns
