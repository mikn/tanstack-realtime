 ...
 *
 * Optional Drizzle/Postgres reactive-query engine for `@realtimejs/core`.
 *
 * This package is intentionally separate from `@realtimejs/preset-start`
...
// consumer can implement a custom engine without importing `@realtimejs/core`
// directly.
export type {
  ReactiveQueryEngine,
  CapturedRead,
